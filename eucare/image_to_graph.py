...
def image_to_graph(image: str | np.ndarray, threshold: float | None = None, closing_iterations: int = 3, edge_length_cutoff: float | None = None, max_size: int = 1000) -> "ec.half.EuclideanPositionHEG":
