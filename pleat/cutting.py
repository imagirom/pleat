...
if TYPE_CHECKING:
    from pleat.half import EuclideanPositionHEG, HalfEdgeGraph
from pleat.overlap import group_closeby, intervals_overlapping, line_segment_intersections
from pleat.rendering import inset_poly
